...
namespace Program
{
    class Program
    {
        private static void lab_2()
        {
            ...
            Console.WriteLine($"{t1} + {t2} = {t1+t2} => " + b1.ToString() + " + " + b2.ToString() + " = " + RomanNumber.Add(b1, b2));
            Console.WriteLine($"{t1} - {t2} = {t1-t2} => " + b1.ToString() + " - " + b2.ToString() + " = " + RomanNumber.Sub(b1, b2));

            Console.WriteLine($"{t3} = " + b3.ToString());
            Console.WriteLine($"{t4} = " + b4.ToString());

            Console.WriteLine($"{t3} * {t4} = {t3*t4} => " + b3.ToString() + " * " + b4.ToString() + " = " + RomanNumber.Mul(b3, b4));
            Console.WriteLine($"{t3} / {t4} = {t3/t4} => " + b3.ToString() + " / " + b4.ToString() + " = " + RomanNumber.Div(b3, b4));
